...
ghcr_token     = "REDACTED_GHCR_TOKEN"
ghcr_image_tag = "latest"
ghcr_owner     = "jmassardo"

# ── Application Secrets (Core) ─────────────────────────────────────────────────

secret_database_url      = "postgresql+asyncpg://octowatch:REDACTED_DB_PASSWORD_2@db:5432/octowatch"
secret_secret_key        = "REDACTED_SECRET_KEY"
secret_encryption_key    = "Y8V0pBycKW6x82ugZcb4EQWBXJ3_Vhb2qY7wLS-tkRU="
secret_valkey_url        = "redis://:REDACTED_DB_PASSWORD_1@valkey:6379/0"
secret_valkey_password   = "REDACTED_DB_PASSWORD_1"
secret_postgres_user     = "octowatch"
secret_postgres_password = "REDACTED_DB_PASSWORD_2"
