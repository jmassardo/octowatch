...
- `aks.tf` — **LEGACY** — AKS resources gated behind `var.enable_aks` (disabled)
...
## Important Notes
- `aks.tf` is retained for reference but disabled via `var.enable_aks = false`. Do not add new AKS resources.
